...
const SLIDES = [
  ...
  {
    type: "table",
    title: "Six Streams Of Income",
    caption: "One dollar in. Six ways out.",
    numCol: 0,
    columns: ["Stream", "Buyer", ""],
    rows: [
      ["Public health", "HHS", "America's Gut Index — catch disease before it spreads"],
      ["Municipal", "Cities", "Sold via Starbridge"],
      ["Alternative data", "Hedge funds, biotech, labs", "Verified foot traffic"],
      ["Toilet paper ads", "Advertisers", "QR on every sheet"],
      ["Subscription", "Members", "$1 a year"],
      ["Card perks", "Credit networks", "A benefit in every wallet"],
    ],
  },
  {
    type: "table",
